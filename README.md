...
- **관리자**: 사용자/카테고리/캐시/주식구독/WOL 관리, 감사 로그
- **보안**: PDO Prepared Statement, CSRF 토큰, HTMLPurifier, 로그인 레이트 리미팅
...
│   └── Models/            # DB 접근 + 캐시 계층 (Post, User, Category, Stock, WolDevice)
├── views/
...
| `login_rate_limit` | IP 15회/분, 사용자 5회/분 | 초과 시 10분 차단 |
